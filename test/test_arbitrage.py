...
from utils.graph_structure import build_graph_from_edge_lists
from utils.graph_utils import analyze_graph
from src.arbitrage_detector_integrated import IntegratedArbitrageDetector, detect_arbitrage
from test.arbitrage_test_data import arbitrage_test_edges, balanced_test_edges
...
def test_arbitrage_detection():
    ...
    graph_with_arbitrage = build_graph_from_edge_lists(arbitrage_test_edges)
